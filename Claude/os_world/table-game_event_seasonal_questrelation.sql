...
-- Dumping structure for table os_world.game_event_seasonal_questrelation
...
-- Dumping data for table os_world.game_event_seasonal_questrelation: ~690 rows (approximately)
