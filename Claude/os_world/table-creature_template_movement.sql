...
-- Dumping structure for table os_world.creature_template_movement
...
-- Dumping data for table os_world.creature_template_movement: ~4,393 rows (approximately)
